...
#define CMRI_NODE_DESCRIPTION  "BBLeo BASE_NODE_8OUT8IN + I2C"
...
ioMap *setupMap() {
    ...
    iomap->add(OUTPUT,  BUILTIN,         6,   OUTPUT_LOW   | INVERT ); //  Trackside Light track 3
    iomap->add(OUTPUT,  BUILTIN,         7,   OUTPUT_LOW   | INVERT ); //  Trackside Light track 4
    ...
    iomap->add(INPUT,   BUILTIN,        12,   INPUT                 ); //  Detector Staging Entry
    iomap->add(INPUT,   BUILTIN,        13,   INPUT        | INVERT ); //  Detector Staging Exit
    iomap->add(INPUT,   BUILTIN,        A0,   INPUT_PULLUP | INVERT ); //  Detector Yard Track 1 entry
    iomap->add(INPUT,   BUILTIN,        A1,   INPUT_PULLUP | INVERT ); //  Detector Yard Track 1 exit
    iomap->add(INPUT,   BUILTIN,        A2,   INPUT_PULLUP | INVERT ); //  Detector Yard Track 2 entry
    iomap->add(INPUT,   BUILTIN,        A3,   INPUT_PULLUP | INVERT ); //  Detector Yard Track 2 exit
    iomap->add(INPUT,   BUILTIN,        A4,   INPUT_PULLUP | INVERT ); //  Detector Yard Track 3 entry
    iomap->add(INPUT,   BUILTIN,        A5,   INPUT_PULLUP | INVERT ); //  Detector Yard Track 3 exit
